...
#include "U_ShapeBase_T.h"

AU_ShapeBase_T::AU_ShapeBase_T()
{

}

void AU_ShapeBase_T::BeginPlay()
{
    Super::BeginPlay();
}

void AU_ShapeBase_T::SetBlockPositions()
{
    ...
    switch(U_Orientation)
    {
        ...
        case 1:
            ...
            U_BlockShapes[1]->SetActorLocation(U_BlockPositions[3] + GetActorLocation());
        break;
        ...
        case 2:
            ...
            U_BlockShapes[2]->SetActorLocation(U_BlockPositions[4] + GetActorLocation());
            U_BlockShapes[3]->SetActorLocation(U_BlockPositions[5] + GetActorLocation());
            U_BlockShapes[1]->SetActorLocation(U_BlockPositions[7] + GetActorLocation());
            break;
