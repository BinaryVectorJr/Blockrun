...
#include "U_ShapeBase_O.h"

AU_ShapeBase_O::AU_ShapeBase_O()
{

}

void AU_ShapeBase_O::BeginPlay()
{
    Super::BeginPlay();
}

void AU_ShapeBase_O::SetBlockPositions()
{
    ...
    switch(U_Orientation)
    {
        case 0:
            ...
            U_BlockShapes[2]->SetActorLocation(U_BlockPositions[3] + GetActorLocation());
